...
public class PlayerTest : MonoBehaviour
{
    ...
    {
        StopAllCoroutines();
        StartCoroutine(SpeedUpCoroutine(newSpeed, duration));
    }
    IEnumerator SpeedUpCoroutine(float newSpeed,float duration)
    {
        walkSpeed = newSpeed;
        yield return new WaitForSeconds(duration);
        walkSpeed = normalSoeed;
    }
}